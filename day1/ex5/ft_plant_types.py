...
if __name__ == "__main__":
    ...
    print(f"{flower2.name} (Flower): {flower2.height}cm, {flower2.age} days, "
          f"{flower2.color} color")
    flower.bloom()
    flower2.bloom()
    print("\n")
    print(f"{tree.name} (Tree): {tree.height}cm, {tree.age} days, "
          f"{tree.trunk_diameter} diameter")
    print(f"{tree2.name} (Tree): {tree2.height}cm, {tree2.age} days, "
          f"{tree2.trunk_diameter} diameter")
    tree.produce_shade()
    tree2.produce_shade()
    print("\n")
    print(f"{vegetable.name} (Vegetable): {vegetable.height}cm, "
          f"{vegetable.age} days, {vegetable.harvest_season} harvest")
    print(f"{vegetable2.name} (Vegetable): {vegetable2.height}cm, "
          f"{vegetable2.age} days, {vegetable2.harvest_season} harvest")
    print(f"{vegetable.name} is rich in Vitamin {vegetable.nutritional_value}")
    print(f"{vegetable2.name} is rich in Vitamin "
          f"{vegetable2.nutritional_value}")
